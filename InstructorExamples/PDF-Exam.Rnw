...
\paragraph{Problem 1.} \Sexpr{knit_child('Variation-201.Rnw')}

\paragraph{Problem 2.} \Sexpr{knit_child('DF-F2013-002.Rnw')}

\paragraph{Problem 3.} \Sexpr{knit_child('DF-F2013-001.Rnw')}

\newpage

\paragraph{Problem 4.} \Sexpr{knit_child('car-model-graphs.Rnw')}

\newpage

\paragraph{Problem 5.} \Sexpr{knit_child("Folliage-1.Rnw")}
